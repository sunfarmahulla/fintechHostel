<div id="dtBox"></div><!-- End datepicker -->
    ...
    <footer style="background: url('frontend/img/banners.jpg');  object-fit:cover" >
       <div class="container">
            <div class="row col-sm-12">
                <center>
                <h1>Search your next house!</h1>
                </br></br></br>
                <p style="color:black">We are hear to help you for finding the next suitable, comfortaible house.
                </br>Like you home. So explore and book now.</p>
                </br></br></br>
                    <ul id="contact_details_footer" style="color:black">
                         <li>Banglore, India<br></li>
                       <li ><a href="tel://004542344599" class="btn btn_1" style="color:black;">+45 423 445 998 ->Book Now</a><a href="#0"><script data-cfhash='f9e31' type="text/javascript">/* <![CDATA[ */!function(t,e,r,n,c,a,p){try{t=document.currentScript||function(){for(t=document.getElementsByTagName('script'),e=t.length;e--;)if(t[e].getAttribute('data-cfhash'))return t[e]}();if(t&&(c=t.previousSibling)){p=t.parentNode;if(a=c.getAttribute('data-cfemail')){for(e='',r='0x'+a.substr(0,2)|0,n=2;a.length-n;n+=2)e+='%'+('0'+('0x'+a.substr(n,2)^r).toString(16)).slice(-2);p.replaceChild(document.createTextNode(decodeURIComponent(e)),c)}p.removeChild(t)}}catch(u){}}()/* ]]> */</script></a></li>
                   </ul>
                </center>
               ...
               <div class="col-md-6 col-sm-12">
                   <img src="logo/logo.png" width="140" height="120" alt="" id="logo_footer" data-retina="true">
