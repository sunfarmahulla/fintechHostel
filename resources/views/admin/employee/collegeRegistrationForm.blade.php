...
<div class="nk-block nk-block-lg">
    ...
    <div class="card card-bordered">
        <div class="card-inner">
            ...
            <form action="ad/clg-registration" class="gy-3" enctype="multipart/form-data" method="POST">
            @csrf
                ...
                <div class="row g-3 align-center">
                    ...
                    <div class="col-lg-7">
                        <div class="form-group">
                            <div class="form-control-wrap">
                                <input type="text" class="form-control" name="clg_name"  value="{{old('clg_name')}}" placeholder="College name" required>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row g-3 align-center">
                    ...
                    <div class="col-lg-7">
                        <div class="form-group">
                            <div class="form-control-wrap">
                                <textarea class="form-control" name="clg_address_1" value=""  placeholder="college Address 1" required>{{old('clg_address_1')}}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row g-3 align-center">
                    ...
                    <div class="col-lg-7">
                        <div class="form-group">
                            <div class="form-control-wrap">
                                <input type="text" class="form-control" name="clg_city"  value="{{old('clg_city')}}" placeholder="City name" required>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row g-3 align-center">
                    ...
                    <div class="col-lg-7">
                        <div class="form-group">
                            <div class="form-control-wrap">
                                <input type="text" class="form-control" name="clg_pin"  value="{{old('clg_pin')}}" placeholder="postel code" required>
                            </div>
                        </div>
                    </div>
                </div>
